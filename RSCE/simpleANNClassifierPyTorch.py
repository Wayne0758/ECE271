...
class NeuralNet(nn.Module):
    ...
    def fit(self, trData, trLabels, standardizeFlag, batchSize, optimizationFunc='Adam', learningRate=0.001, m=0,
            numEpochs=100, cudaDeviceId=0, verbose=False):
        ...
        torchData = Data.TensorDataset(torch.from_numpy(trData).float(),
                                       torch.from_numpy(trLabels.flatten().astype(int)))
