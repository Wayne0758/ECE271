...
from FeatureSelectingSCEPyTorchNew import FeatureSelectingSCE
import pickle
...
def load_ALLAML_Data(flag = 'Trn', partition=0):
    # load data file
    data = sio.loadmat(f"G:\Machine Learning\ECE271A_Project_GPU\master\lung.mat")
    X = data['X']
    y = data['Y']
